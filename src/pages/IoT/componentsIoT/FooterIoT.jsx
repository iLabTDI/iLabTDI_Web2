          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-6 md:space-y-0">
            ...
            <div className="flex items-center space-x-8">
              <div className="flex items-center">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/cucei-COZMlvtC7kndgIxvtDdbHqiCDWZhlm.png"
                  alt="CUCEI"
              ...
              <div className="flex items-center">
                <img
                  src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/DIVTIC-482cMyUWp9uC0bWsd4eQ6ENzZuTnQh.png"
                  alt="DIVTIC"
                  className="h-12 opacity-90 hover:opacity-100 transition-opacity duration-200"
                />
              </div>
