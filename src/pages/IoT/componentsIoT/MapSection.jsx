      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Estamos ubicados en el Centro Universitario de Ciencias Exactas e
            Ingenierías de la Universidad de Guadalajara.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="relative w-full">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
              {/* Tamaño fijo en escritorio, responsivo en móvil */}
              <div className="w-full h-64 aspect-[4/3] lg:w-[600px] lg:h-[600px] lg:aspect-auto">
                <iframe
                  ...
                  title="Ubicación Laboratorio IoT"
                ></iframe>
              </div>
            </div>
          </div>
