...
function NavBar() {
  ...
  return (
    <header
      className="fixed top-0 left-0 w-full z-[1000] bg-[#18122B]/80 shadow-lg backdrop-blur-md"
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto flex items-center justify-between px-4 md:px-10 h-20">
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Botón destacado para documentos */}
          <Link
            to="/documentos"
      ...
      <div
        className={`md:hidden w-full bg-[#18122B]/90 shadow-lg transition-all duration-300 overflow-hidden ${
      ...
      >
        <nav className="flex flex-col gap-2 px-6">
          ...
          <Link
            to="/documentos"
            className="flex items-center gap-3 bg-gradient-to-r from-[#a78bfa] to-[#ff5ca9] hover:from-[#5ca9fb] hover:to-[#a78bfa] text-white font-bold px-4 py-3 rounded-xl shadow-lg text-lg transition-all duration-200 mt-2"
